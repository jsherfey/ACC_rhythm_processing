function S = getGenExtPoissonTotalGating(tOn,tOff,latency_,freq_,normFreqSigma_,phase_,widthSigma,rate_baseline,rate_dc_,rate_ac_,tau,kick,N,interval,dt,conn)
% 16-Feb-2016: JSS added conn as connectivity input argument [1 x num_cells]
  ...
  if nargin<16, conn=ones(N,1);         end
