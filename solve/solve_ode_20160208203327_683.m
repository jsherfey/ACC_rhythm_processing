function [T,E_v,E_iNa_m,E_iNa_h,E_iK_n,If_v,If_iNa_m,If_iNa_h,If_iK_n,Is_v,Is_iNa_m,Is_iNa_h,Is_iK_n,If_E_iAMPA_s,Is_E_iAMPA_s,E_If_iGABAa_s,E_Is_iGABAa_s,E_If_iGABAa_ISYN,E_Is_iGABAa_ISYN,If_E_iAMPA_ISYN,Is_E_iAMPA_ISYN,E_s1,E_s2,E_K1,E_K2,If_E_iAMPA_netcon,Is_E_iAMPA_netcon,E_If_iGABAa_netcon,E_Is_iGABAa_netcon]=solve_ode
% ------------------------------------------------------------
% Parameters:
% ------------------------------------------------------------
...
% Fixed variables:
% ------------------------------------------------------------
E_s1 = get_input('poisson',p.E_Npop,T,p.E_f1,p.E_dc,p.E_ac,p.E_tau,p.E_xc1,p.E_baseline,p.E_phase1);
E_s2 = get_input('poisson',p.E_Npop,T,p.E_f2,p.E_dc,p.E_ac,p.E_tau,p.E_xc2,p.E_baseline,p.E_phase2);
E_K1 = [+1.00000000   +1.00000000   +1.00000000   +1.00000000   +0.00000000   +0.00000000   +0.00000000   +0.00000000];
E_K2 = [+0.00000000   +0.00000000   +0.00000000   +0.00000000   +1.00000000   +1.00000000   +1.00000000   +1.00000000];
